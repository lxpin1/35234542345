...
The output is based on a `<ul>` element, however you can use some custom CSS to make the `<ul>` list display horizontally, and optionally with a separating character, such as a comma. See this [custom CSS example](https://jsfiddle.net/1vz57kyj/).
...
[More information](https://wordpress.org/support/article/managing-plugins/#installing-plugins-1)
